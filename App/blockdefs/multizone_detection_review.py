def get_definition():
    return {
        "name": "MultizoneDetectionReview",
        "displayName": "Detection Review (mz)",
        "category": "Detection",
        "color": [0.72, 0.28, 0.28],
        "inputs": [
            {"name": "dataIn", "type": "numeric", "required": True, "description": "Multi-zone signal (N×Z, Z≥2)"},
        ...
        "isInteractive": True,
        "runner": "runMultizoneDetectionReview",
    }
